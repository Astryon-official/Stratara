...
int main(int argc, char *argv[])
{
    ...
    // Stratara visual foundation
    application.setFont(QFont(QStringLiteral("Montserrat")));

    QPalette palette = application.palette();
    palette.setColor(QPalette::Window, QColor("#000000"));
    palette.setColor(QPalette::Base, QColor("#0b0b0f"));
    palette.setColor(QPalette::AlternateBase, QColor("#111116"));
    palette.setColor(QPalette::Button, QColor("#15151a"));
    ...
    palette.setColor(QPalette::Mid, QColor("#303139"));
    palette.setColor(QPalette::Dark, QColor("#09090d"));
    palette.setColor(QPalette::Light, QColor("#3a3b44"));
    palette.setColor(QPalette::Highlight, QColor("#dfe0e5"));
    palette.setColor(QPalette::HighlightedText, QColor("#101014"));
    palette.setColor(QPalette::PlaceholderText, QColor("#73747c"));

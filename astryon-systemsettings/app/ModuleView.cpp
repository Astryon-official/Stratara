...
void ModuleView::addModule(MenuItem *item, const QStringList &args)
{
    ...
    moduleScroll->setStyleSheet(QStringLiteral("QScrollArea { background: #000000; border: none; } QScrollBar:vertical { background: transparent; width: 10px; margin: 8px 3px 8px 0; } QScrollBar::handle:vertical { background: #303139; min-height: 40px; border-radius: 5px; } QScrollBar::handle:vertical:hover { background: #484952; } QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical, QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical { background: transparent; border: none; }"));
